...
#this code is for calculating bending moment and shear force at different distances
import numpy as np
...
print(M) # the bending moment value at x = 0

#shear force at x=0
x=0
V = w*(L/2 - x)
print(V) # shear force value at 0
